...
const ErrorPages = () => {
    return (
        <section className="flex items-center h-full sm:p-16 dark:bg-[#111827] dark:text-gray-800 min-h-screen text-white">
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
		...
		<p className="text-3xl text-white">Looks like our services are currently offline</p>
